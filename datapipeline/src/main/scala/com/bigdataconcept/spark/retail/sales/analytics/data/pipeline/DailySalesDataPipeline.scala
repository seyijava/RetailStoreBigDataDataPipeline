...
import com.bigdataconcept.spark.retail.sales.analytics.data.pipeline.domain.Domain.{DailySale, DailySaleRecord}
import com.bigdataconcept.spark.retail.sales.analytics.data.pipeline.domain.DomainCodecs.dailySale
